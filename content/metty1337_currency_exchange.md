...
### Тест приложения
- В целом для проекта этого уровня работает нормально в позитивных сценариях. Ломать через postman не стал, т.к. считаю, что все кейсы предусмотреть нельзя. Оставляю это вам. Если есть желание сделать валидацию на все случаи жизни, то делайте
- http://194.135.46.52:8080//currencies отправляется запрос с 2-мя слэшами, должен быть 1 слэш
